...
namespace ModulesFrameworkUnity.DebugWindowFeature.Modules.GraphView
{
    public class ModuleNode : Node
    {
        ...
        private readonly Dictionary<Type, Label> _composedModulesLabels = new();
        ...
        public IReadOnlyDictionary<Type, Label> ComposedModulesLabels => _composedModulesLabels;
        ...
        {
            if (isHighlighted)
                AddToClassList("mf--module-node--highlight");
            else
                RemoveFromClassList("mf--module-node--highlight");
        }
        ...
        public void AddComposed(Type moduleType)
        {
            ...
            var label = new Label
            {
                text = moduleType.GetTypeName()
            };
            _composedOfContainer.Add(label);
            _composedModulesLabels[moduleType] = label;
        }
        ...
        public void RefreshAdjustedHeight()
        {
            ...
            const float submoduleHeight = 35;
